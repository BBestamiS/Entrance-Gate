            ...
            <section class="color-info">
                        ...
                        <div class="entry-list-div">
                            <section class="staff-info-section">
                                ...
                                <?php
                                foreach(getStaffs() as $item){
                                    $staff = getStaff($item['staff_id']);
                                    ?>
                                    <div class="staff-info-list-div">
                                        <?php
                                        if($item['exit_date'] == null){?>
                                            <a href="main.php?selection=getall&entryid=<?php echo $item['id'] ?>&staffid=<?php echo $item['staff_id'] ?>"  class="staff-info-list-bg">
                                                <?php
                                        } else {?>
                                            <a href="main.php?selection=getall&entryid=<?php echo $item['id'] ?>&staffid=<?php echo $item['staff_id'] ?>"  class="staff-info-list-bg1">
                                                <?php
                                        }
                                        ?>
                            ...
                            <section class="guest-info-section">
                                ...
                                <?php
                                foreach(getGuests() as $item){
                                    ?>
                                    <div class="staff-info-list-div">
                                    <?php
                                        if($item['exit_date'] == null){?>
                                            <a href="main.php?selection=getall&guestid=<?php echo $item['id'] ?>"  class="staff-info-list-bg">
                                                <?php
                                        } else {?>
                                            <a href="main.php?selection=getall&guestid=<?php echo $item['id'] ?>"  class="staff-info-list-bg1">
                                                <?php
                                        }
                                        ?>
                                            <div class="staff-name-surname-div">
